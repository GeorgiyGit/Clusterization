...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240326002319_add-quote-packs")]
    partial class addquotepacks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Quotes.CustomerQuotes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Quotes.QuotesLogs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("QuotesLogs");
                });

            modelBuilder.Entity("Domain.Entities.Quotes.QuotesPack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("QuotesPacks");
                });

            modelBuilder.Entity("Domain.Entities.Quotes.QuotesPackItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("QuotesPackItems");
                });

            modelBuilder.Entity("Domain.Entities.Quotes.QuotesPackLogs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("QuotesPackLogs");
                });

            modelBuilder.Entity("Domain.Entities.Quotes.QuotesType", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.Quotes.CustomerQuotes", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Quotes.QuotesType", "Type")
            ...
            modelBuilder.Entity("Domain.Entities.Quotes.QuotesPackItem", b =>
                {
                    b.HasOne("Domain.Entities.Quotes.QuotesPack", "Pack")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Domain.Entities.Quotes.QuotesPackLogs", b =>
                {
                    b.HasOne("Domain.Entities.Customers.Customer", "Customer")
                        .WithMany("QuotesPackLogsCollection")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Customers.Customer", b =>
                {
                    ...
                    b.Navigation("QuotesLogsCollection");

                    b.Navigation("QuotesPackLogsCollection");
