...
{
    internal class SpectralClusteringAlgorithmBuilder : IEntityTypeConfiguration<SpectralClusteringAlgorithm>
    {
        public void Configure(EntityTypeBuilder<SpectralClusteringAlgorithm> builder)
        {
