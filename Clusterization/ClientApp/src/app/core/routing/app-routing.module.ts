...
import { YoutubeLoadMultipleChannelsComponent } from "src/app/features/dataSources/youtube/channels/components/youtube-load-multiple-channels/youtube-load-multiple-channels.component";
import { YoutubeLoadOneChannelComponent } from "src/app/features/dataSources/youtube/channels/components/youtube-load-one-channel/youtube-load-one-channel.component";
import { YoutubeChannelListPageComponent } from "src/app/features/dataSources/youtube/channels/pages/youtube-channel-list-page/youtube-channel-list-page.component";
import { YoutubeFullChannelPageComponent } from "src/app/features/dataSources/youtube/channels/pages/youtube-full-channel-page/youtube-full-channel-page.component";
import { YoutubeLoadNewChannelPageComponent } from "src/app/features/dataSources/youtube/channels/pages/youtube-load-new-channel-page/youtube-load-new-channel-page.component";
import { YoutubeCommentListPageComponent } from "src/app/features/dataSources/youtube/comments/pages/youtube-comment-list-page/youtube-comment-list-page.component";
import { YoutubeLoadAllCommentsPageComponent } from "src/app/features/dataSources/youtube/comments/pages/youtube-load-all-comments-page/youtube-load-all-comments-page.component";
import { YoutubeLoadCommentsByChannelPageComponent } from "src/app/features/dataSources/youtube/comments/pages/youtube-load-comments-by-channel-page/youtube-load-comments-by-channel-page.component";
import { YoutubeLoadMultipleVideosComponent } from "src/app/features/dataSources/youtube/videos/components/youtube-load-multiple-videos/youtube-load-multiple-videos.component";
import { YoutubeFullVideoPageComponent } from "src/app/features/dataSources/youtube/videos/pages/youtube-full-video-page/youtube-full-video-page.component";
import { YoutubeLoadAllVideosPageComponent } from "src/app/features/dataSources/youtube/videos/pages/youtube-load-all-videos-page/youtube-load-all-videos-page.component";
import { YoutubeVideoListPageComponent } from "src/app/features/dataSources/youtube/videos/pages/youtube-video-list-page/youtube-video-list-page.component";
import { AddYoutubeVideosCommentsToWorkspaceComponent } from "src/app/features/dataSources/youtube/youtube-data-objects/pages/add-youtube-videos-comments-to-workspace/add-youtube-videos-comments-to-workspace.component";
import { AddYoutubeChannelCommentsToWorkspacePageComponent } from 'src/app/features/dataSources/youtube/youtube-data-objects/pages/add-youtube-channel-comments-to-workspace-page/add-youtube-channel-comments-to-workspace-page.component';
const routes: Route[] = [
  {
    path:'',
