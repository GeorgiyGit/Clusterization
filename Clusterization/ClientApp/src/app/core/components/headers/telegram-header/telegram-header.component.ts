...
@Component({
  selector: 'app-telegram-header',
  templateUrl: './telegram-header.component.html',
  styleUrl: './telegram-header.component.scss',
  animations: [
...
export class TelegramHeaderComponent implements OnInit {
  ...
  openLoadChannel(event:MouseEvent){
    ...
    this.closeDisplayPhoneMenu();
    this.router.navigate([{ outlets: { overflow: 'dataSources/telegram/channels/load' } }]);
  }
}
