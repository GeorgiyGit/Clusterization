...
@Component({
  selector: 'app-telegram-channels-tasks-list-page',
  templateUrl: './telegram-channels-tasks-list-page.component.html',
  styleUrl: './telegram-channels-tasks-list-page.component.scss'
})
export class TelegramChannelsTasksListPageComponent implements OnInit {
  tasks: IMyMainTask[] = [];
  ...
  loadFirst() {
    ...
    this.isLoading = true;
    this.entitiesTasksService.getTelegramChannelTasks(this.request).subscribe(res => {
